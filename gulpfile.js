...
gulp.task("fontsBuild", gulp.series(fonts_otf, fonts, fontstyle));
let buildDev = gulp.series(clean, gulp.parallel(copyFolders, json, html, css, js, favicon, images));
